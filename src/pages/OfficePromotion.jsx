    ...
    <div className="office-promo-container">
      <div className="office-content-wrapper container">
        ...
        <div className="vision-mission-grid animate-slide-up-delay-1" style={{ maxWidth: '1100px', margin: '0 auto 4rem' }}>
          ...
          <div className="statement-card" style={{ minHeight: 'auto' }}>
          ...
          <div className="statement-card" style={{ minHeight: 'auto' }}>
            ...
            <p className="statement-text" style={{ fontSize: '0.975rem', lineHeight: '1.75', margin: 0, color: 'rgba(255, 255, 255, 0.85)' }}>
            ...
            <div style={{ padding: '1.25rem', background: 'rgba(255, 255, 255, 0.08)', borderLeft: '4px solid var(--logo-gold)', borderRadius: 'var(--border-radius-md)', backdropFilter: 'blur(5px)' }}>
              <p style={{ fontSize: '0.9rem', fontStyle: 'italic', color: '#ffffff', margin: 0, lineHeight: '1.5' }}>
        ...
        <div className="goals-section animate-slide-up-delay-2" style={{ marginTop: 0, marginBottom: '4rem' }}>
          ...
          <div className="office-career-grid" style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div className="statement-card" style={{ minHeight: 'auto', padding: '2rem' }}>
              ...
              <p className="statement-text" style={{ fontSize: '0.9rem', margin: 0, lineHeight: '1.55', color: 'rgba(255, 255, 255, 0.85)' }}>
        ...
        {/* Explore Section */}
        <section className="statement-card animate-slide-up-delay-2" style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', minHeight: 'auto' }}>
          ...
          <p className="statement-text" style={{ maxWidth: '640px', fontSize: '1rem', margin: 0, lineHeight: '1.6', color: 'rgba(255, 255, 255, 0.85)' }}>
